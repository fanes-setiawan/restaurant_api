...
payment_bp.route('/api/payments', methods=['GET'])(jwt_required()(role_required('admin')(get_all_payments)))
payment_bp.route('/api/orders/<int:order_id>/payments', methods=['GET'])(jwt_required()(get_payments_by_order))
payment_bp.route('/api/payments/<int:payment_id>', methods=['DELETE'])(jwt_required()(role_required('admin')(delete_payment)))
