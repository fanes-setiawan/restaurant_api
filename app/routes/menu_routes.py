...
menu_bp.route('/api/menus', methods=['POST'])(jwt_required()(create_menu))
menu_bp.route('/api/menus/<int:menu_id>', methods=['GET'])(jwt_required()(get_menu_by_id))
menu_bp.route('/api/menus/<int:menu_id>', methods=['PUT'])(jwt_required()(update_menu))
menu_bp.route('/api/menus/<int:menu_id>', methods=['DELETE'])(jwt_required()(delete_menu))
